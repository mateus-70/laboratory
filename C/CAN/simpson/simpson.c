...
double f3a(double x) { return x*x/2.0; }
 
double f2(double x) { return 1.0/x; }
 
double f2a(double x) { return log(x); }
 
double f1(double x) { return x*x*x; }
 
double f1a(double x) { return x*x*x*x/4.0; }


double ff1(double x) { return pow(x,4)+3*x-2; }
double ff2(double x) { return sin(x*x+1); }
double ff3(double x) { return pow(2.71828,x*x - 4); }
